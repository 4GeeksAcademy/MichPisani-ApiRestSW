...
def get_all_users():
    ...
    users = User.query.all() #Esto qué devuelve? 
...
# Añadir un nuevo planet favorito al usuario actual con el id = planet_id
# Eliminar un planet favorito con el id = planet_id.
...
# Añade un nuevo vehicle favorito al usuario actual con el id = vehicle_id.
# Elimina un vehicle favorito con el id = vehicle_id.
